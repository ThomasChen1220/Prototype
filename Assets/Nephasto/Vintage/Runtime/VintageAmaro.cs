...
namespace Nephasto
{
  namespace VintageAsset
  {
    ...
    [AddComponentMenu("Image Effects/Nephasto/Vintage/Vintage Amaro")]
    public sealed class VintageAmaro : VintageBase
    {
      ...
      /// Effect description.
      /// </summary>
      public override string ToString() => "This effect adds more light to the centre of the screen and darkens around the edges.";
