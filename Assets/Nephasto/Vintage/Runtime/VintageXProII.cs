...
namespace Nephasto
{
  namespace VintageAsset
  {
    ...
    [AddComponentMenu("Image Effects/Nephasto/Vintage/Vintage XProII")]
    public sealed class VintageXProII : VintageBase
    {
      ...
      /// Effect description.
      /// </summary>
      public override string ToString() => "This effect gives your game a warm vintage feeling and saturated tones.";
