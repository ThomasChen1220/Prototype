...
namespace Nephasto
{
  namespace VintageAsset
  {
    ...
    [AddComponentMenu("Image Effects/Nephasto/Vintage/Vintage Rise")]
    public sealed class VintageRise : VintageBase
    {
      ...
      /// Effect description.
      /// </summary>
      public override string ToString() => "Rise gives your game a nice glow and warmth by adding yellow tones.";
